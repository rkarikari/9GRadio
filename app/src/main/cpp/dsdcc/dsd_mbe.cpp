...
#endif
    mbe_initProcessResult(&m_lastResult);
...
void DSDMBEDecoder::processFrame(char imbe_fr[8][23], char ambe_fr[4][24], char imbe7100_fr[7][24])
{
    ...
    {
        m_errs = mbe_processImbe7200x4400Framef(m_audio_out_temp_buf, &m_lastResult,
                imbe_fr, imbe_d, &m_mbelibParms->m_cur_mp,
                &m_mbelibParms->m_prev_mp, &m_mbelibParms->m_prev_mp_enhanced);
    }
    else if (m_dsdDecoder->m_mbeRate == DSDDecoder::DSDMBERate7100x4400)
    {
        m_errs = mbe_processImbe7100x4400Framef(m_audio_out_temp_buf, &m_lastResult,
                imbe7100_fr, imbe_d,
    ...
    {
        m_errs = mbe_processAmbe3600x2400Framef(m_audio_out_temp_buf, &m_lastResult,
                ambe_fr, ambe_d, &m_mbelibParms->m_cur_mp,
                &m_mbelibParms->m_prev_mp, &m_mbelibParms->m_prev_mp_enhanced);
    }
    else
    {
        m_errs = mbe_processAmbe3600x2450Framef(m_audio_out_temp_buf, &m_lastResult,
                ambe_fr, ambe_d, &m_mbelibParms->m_cur_mp,
                &m_mbelibParms->m_prev_mp, &m_mbelibParms->m_prev_mp_enhanced);
    }
    ...
    {
        m_dsdDecoder->getLogger().log("mbelib-neo errs=%d", m_errs);
    }
...
void DSDMBEDecoder::processData(char imbe_data[88], char ambe_data[49])
{
    ...
    {
        m_errs = mbe_processImbe4400Dataf(m_audio_out_temp_buf, &m_lastResult,
                imbe_data, &m_mbelibParms->m_cur_mp,
                &m_mbelibParms->m_prev_mp, &m_mbelibParms->m_prev_mp_enhanced);
    }
    else if (m_dsdDecoder->m_mbeRate == DSDDecoder::DSDMBERate2400)
    {
        m_errs = mbe_processAmbe2400Dataf(m_audio_out_temp_buf, &m_lastResult,
                ambe_data, &m_mbelibParms->m_cur_mp,
                &m_mbelibParms->m_prev_mp, &m_mbelibParms->m_prev_mp_enhanced);
    }
    else if (m_dsdDecoder->m_mbeRate == DSDDecoder::DSDMBERate2450)
    {
        m_errs = mbe_processAmbe2450Dataf(m_audio_out_temp_buf, &m_lastResult,
                ambe_data, &m_mbelibParms->m_cur_mp,
                &m_mbelibParms->m_prev_mp, &m_mbelibParms->m_prev_mp_enhanced);
    }
    else
